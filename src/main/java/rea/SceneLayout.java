 ...
 * </p>
 * <p>
 * To use basic absolute position, components are added to this layout using the
...
public class SceneLayout extends Div {
     ...
     * @param overlap rectangle already in place.
    ...
    Rectangle onSide(Rectangle tentative, Rectangle overlap, Side side) {
        ...
        return switch (side) {
            case UP -> new Rectangle(tentative.x, overlap.y - tentative.height, tentative.width, tentative.height);
            case DOWN -> new Rectangle(tentative.x, overlap.y + overlap.height, tentative.width, tentative.height);
            case LEFT -> new Rectangle(overlap.x - tentative.width, overlap.y, tentative.width, tentative.height);
            case RIGHT -> new Rectangle(overlap.x + overlap.width, overlap.y, tentative.width, tentative.height);
        };
    }
