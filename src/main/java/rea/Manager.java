...
public final class Manager {
    ...
    private static Set<UpdateListener<GamesUpdateEvent>> listeners = null;
    private static List<GameInstance> gameInstances = null;
    ...
    public static GameInstance createGameInstance(String gameName) {
