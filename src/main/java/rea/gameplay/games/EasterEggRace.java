...
public class EasterEggRace implements Gameplay {
    ...
    private static final Visual[] EGG_VISUAL = {
            new Visual("images/easter-egg-1.png", EGG_WIDTH, EGG_HEIGHT),
            new Visual("images/easter-egg-2.png", EGG_WIDTH, EGG_HEIGHT),
            new Visual("images/easter-egg-3.png", EGG_WIDTH, EGG_HEIGHT)
    };

    private static final Visual LAWN_VISUAL = new Visual("images/lawn.jpg", BACKGROUND_WIDTH, BACKGROUND_HEIGHT);
