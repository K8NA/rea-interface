...
public class TreasureHunt implements Gameplay {
    ...
    private static final Visual EMPTY_ROOM_VISUAL = new Visual("some/path/empty_room.png", BACKGROUND_WIDTH, BACKGROUND_HEIGHT);
    private static final int KEY_HEIGHT = 50;
    private static final int KEY_WIDTH = 70;
    private static final Visual KEY_VISUAL = new Visual("some/path/key.png", KEY_WIDTH, KEY_HEIGHT);
    private static final int TREASURE_HEIGHT = 200;
    private static final int TREASURE_WIDTH = 300;
    private static final Visual TREASURE_VISUAL = new Visual("some/path/treasure.png", TREASURE_WIDTH, TREASURE_HEIGHT);
    ...
    private static final Visual HOUSE_CLOSE_DOOR_VISUAL = new Visual("some/path/house_closed_door.png", HOUSE_WIDTH, HOUSE_HEIGHT);
    private static final Visual HOUSE_OPEN_DOOR_VISUAL = new Visual("some/path/house_open_door.png", HOUSE_WIDTH, HOUSE_HEIGHT);
    ...
    public GameMap makeGameMap() {
        Place startPlace = new Place(LAWN_VISUAL, "Start", new Position(20, 60));
